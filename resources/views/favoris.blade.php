...
<p><i class="fa fa-bookmark"></i> Recettes <strong style='color:red'>Sauvegarder</strong></p>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <button class="fa fa-bookmark" data-toggle="modal" data-target="#exampleModal" style='font-size:30px;'></button>
        <!--modal supprimer -->
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                Vous voulez vraiment supprimer cette recette du liste des favoris?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <a href="/supprimerFav/{{$recettes->id_user}}/{{$recettes->id_recette}}" class="btn btn-danger" >Supprimer</a>
            </div>
            </div>
        </div>
        </div>
